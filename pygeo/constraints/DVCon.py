...
class DVConstraints:
    ...
    def addAreaMomentConstraint(
        ...
        lower : float or dict
            ...
            When using a dict the keys Ixx, Iyy, and Jz are supported.
            Values can either be float or an array of size (nSpan)

            Examples:

            * Assign a lower bound to Ixx, Iyy, and Jz at once::
            ...
            * Assign lower bound of 1.0 to Ixx and Jz at all span locations.
              Iyy is specified at (all) three span locations::

                lower = {"Ixx": 1.0, "Iyy": [1.0, 0.9, 0.8], "Jz": 1.0}

        upper : float or dict
            The upper bound for the constraint. See lower bound above
